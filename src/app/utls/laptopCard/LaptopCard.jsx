    ...
    return (
        <div className="group bg-gray-50 border-2 rounded flex gap-1 py-5 items-center justify-between flex-col w-full relative">
            ...
            <div className=' w-full px-2  relative overflow-hidden'>
                <Image alt={laptop.dataUrl} height={125} width={220} src={laptop.images[0]} className='w-full aspect-video bg-transparent border-transparent outline-transparent duration-100  hover:scale-110'></Image>
            ...
            <Link className='text-sm font-semibold px-2 text-blue-700' href={"laptops/" + laptop.dataUrl}>{laptop.laptop.brand + " " + laptop.laptop.model + " " + laptop.memory.ram}</Link>
